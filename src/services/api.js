...
const transformSiteTexts = (data) => {
  ...
  return {
    ...
    packageInfo: {
      ...
      day: data.packageInfoDay,
      dayOf: data.packageInfoDayOf,
      pricePerPerson: data.packageInfoPricePerPerson,
      notSureLevel: data.packageInfoNotSureLevel,
      additionalPhotos: data.packageInfoAdditionalPhotos,
      howToGetHere: data.packageInfoHowToGetHere,
      mapComingSoon: data.packageInfoMapComingSoon,
      quote: data.packageInfoQuote,
      quoteResponse: data.packageInfoQuoteResponse,
