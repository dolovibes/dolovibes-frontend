...
export const SiteTextsProvider = ({ children }) => {
    ...
    const texts = useMemo(() => ({
        ...
        navbar: {
            ...
            ourExperiences: getText('navbar.ourExperiences', 'navbar.ourExperiences'),
        ...
        // Etiquetas
        labels: {
            perPerson: getText('labels.perPerson', 'labels.perPerson', 'common'),
            days: getText('labels.days', 'labels.days', 'common'),
            persons: getText('labels.persons', 'labels.persons', 'common'),
        },
        // Campos genéricos
        optional: getText('fieldOptional', 'optional'),
        // Estados de carga
        loading: {
            generic: getText('loading.generic', 'loading.generic', 'common'),
        },
        ...
        selector: {
            ...
            scrollToSeeTrips: getText('selector.scrollToSeeTrips', 'selector.scrollToSeeTrips'),
        },
        ...
        footer: {
            ...
            experiences: getText('footer.experiences', 'footer.experiences'),
            information: getText('footer.information', 'footer.information'),
            contact: getText('footer.contact', 'footer.contact'),
        },
        // Booking / Packages
        booking: {
        ...
        packageInfo: {
            ...
            yourAdventure: getText('packageInfo.yourAdventure', 'yourAdventure', 'packageInfo'),
            day: getText('packageInfo.day', 'day', 'packageInfo'),
            dayOf: getText('packageInfo.dayOf', 'dayOf', 'packageInfo'),
            pricePerPerson: getText('packageInfo.pricePerPerson', 'pricePerPerson', 'packageInfo'),
            notSureLevel: getText('packageInfo.notSureLevel', 'notSureLevel', 'packageInfo'),
            additionalPhotos: getText('packageInfo.additionalPhotos', 'additionalPhotos', 'packageInfo'),
            howToGetHere: getText('packageInfo.howToGetHere', 'howToGetHere', 'packageInfo'),
            quote: getText('packageInfo.quote', 'quote', 'packageInfo'),
            quoteResponse: getText('packageInfo.quoteResponse', 'quoteResponse', 'packageInfo'),
            mapComingSoon: getText('packageInfo.mapComingSoon', 'mapComingSoon', 'packageInfo'),
